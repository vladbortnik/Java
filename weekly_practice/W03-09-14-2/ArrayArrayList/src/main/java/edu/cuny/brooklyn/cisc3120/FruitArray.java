...
public class FruitArray 
{
	...
	public void delete(String fruitName) {
		for(int i=0; i<size; i++) {			// Here's my method.
		...
		/*	MY COMMENT:
		 * 
		 * 	Since we comparing two strings ignoring case we need such a method.
		 * 	I found method -> public boolean equalsIgnoreCase(String anotherString).
