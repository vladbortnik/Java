...
//    private String newFileName = null;
    ...
    void aboutInfo(ActionEvent event) {
    		Alert alert = new Alert(AlertType.INFORMATION, "This app is edited by Vladimir Bortnik!", ButtonType.CLOSE);
        alert.setTitle("About");
        alert.setHeaderText("Simple Editor 2.0");
        alert.showAndWait();
    }
    ...
    private class HTMLEditorContentChangeListener {
        ...
        public HTMLEditorContentChangeListener(final HTMLEditor editor) {
             ...
             *  you will not be able to edit the content, because the above code
...
//    		newFileName = editor.getTheFile().getPath();
//    		return newFileName;
//    }
    
//    	  public SimpleEditor getTheEditor() {
//    		  return editor;
//    	  }
