...
public class I18n {
    ...
    public static void saveLocaleToFile(ResourceBundle bundle) throws IOException {
    		FileWriter outputStream = null;
    		outputStream = new FileWriter("src/main/resources/locale_config.txt");
    		outputStream.write(bundle.getLocale().toString());
    		outputStream.close();
    }
